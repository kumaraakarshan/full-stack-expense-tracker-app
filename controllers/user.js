...
//     sequelize.query(checkEmailSql, [email], (checkErr, checkResults) => {
//       if (checkErr) {
...
//         sequelize.query(insertSql, [name, email, phone, hashedPassword], (insertErr, result) => {
//           if (insertErr) {
...
//     sequelize.query(sql, [email], (err, results) => {
//       if (err) {
